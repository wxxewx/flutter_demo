    ...
    return StreamBuilder<List<TweetTheme>>(
        ...
        builder: (context, snapshot) {
          ...
          return Container(
            ...
            child: ListView(
                children: list
                    .map((e) => StreamBuilder<TweetTheme>(
                        stream: bloc.checkTheme,
                        initialData: null,
                        builder: (context, snapshot) {
                                  ...
                                  Visibility(
                                    child: Column(
                                      children: [
                                        Divider(
                                          color:
                                              theme.themeColor.themeGreyColor,
                                        ),
                                        Container(
